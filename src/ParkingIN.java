...
public class ParkingIN {
    static public Parking parse_input_file(String filename) {
        ...
        try{
            ...
            parse_emplaceme(file_reader, numOfCar[0] + numOfCar[1], baseParking);
    ...
    static private void parse_emplaceme(BufferedReader file, int carNumber, Parking parkingRef){
		try{
			String line;
			line=file.readLine();	//emplacement
