...
Une optimisation possible du problÍme est de ne pas seulement considÈrer les
dÈplacements \emph{d'une case} mais aussi les mouvements de plusieurs cases
(sur les lignes des voitures). De cette faÁon on peut gÈnÈrer moins de cas.
Le problÍme est qu'avec cette optimisation on gÈnËre moins de cas seulement si pour
rÈsoudre le problÍme il faut faire avancer deux fois ou plus une voiture sur sa
ligne, sinon le nombre d'opÈration dans l'algorithme sera plus ÈlevÈ.
