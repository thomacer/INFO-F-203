...
Dans ce tableau, chaque case peut contenir une partie de voiture (chaque
voiture occupe deux cases).
...
L'unique voiture qui a le droit de sortir du tableau la voiture Goal.
...
Exemple de résultat en utilisant l'exemple de fichier au-dessus passé en
argument. \newline
...
Une optimisation possible du problême est de ne pas seulement considérer lors
